        ...
        if (pathFile.length == 1) {
            if (archivos.get(0).getPath().contains(".zip")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[0], body, "multipart/form-data")
                        .multiPart(nameKeys[1], archivos.get(0), "application/zip")
                        .when()
                        .post(resource);
            } else if (archivos.get(0).getPath().contains(".xlsx")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        ...
                        .when()
                        .post(resource);
            } else if (archivos.get(0).getPath().contains(".txt")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        ...
                        .when()
                        .post(resource);
            } else if (archivos.get(0).getPath().contains(".docx")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        ...
                        .when()
                        .post(resource);
            } else if (archivos.get(0).getPath().contains(".pdf")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                ...
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[0], body, "multipart/form-data")
                        .multiPart(nameKeys[1], "", "application/zip")
                        .when()
                        .post(resource);
            }
        }
        if (pathFile.length == 2) {
            if (pathFile[0].isEmpty() && !pathFile[1].isEmpty()) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[0], body, "multipart/form-data")
                        .multiPart(nameKeys[1], "", "application/zip")
                        .multiPart(nameKeys[2], archivos.get(1), "application/zip")
                        .when()
                        .post(resource);
            } else if (!pathFile[0].isEmpty() && pathFile[1].isEmpty()) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[0], body, "multipart/form-data")
                        .multiPart(nameKeys[1], archivos.get(0), "application/zip")
                        .multiPart(nameKeys[2], "", "application/zip")
                        .when()
                        .post(resource);
            } else if (pathFile[0].isEmpty() && pathFile[1].isEmpty()) {
                rest().relaxedHTTPSValidation()
        ...
        if (pathFile.length == 4) {
            if (archivos.get(0).getPath().contains(".pdf")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[1], archivos.get(0), "application/pdf")
                        .multiPart(nameKeys[2], archivos.get(1), "application/pdf")
                        .multiPart(nameKeys[3], archivos.get(2), "application/pdf")
                        .multiPart(nameKeys[4], archivos.get(3), "application/pdf")
                        .multiPart(nameKeys[0], body, "text/plain")
                        .when()
                        .post(resource);
            }else if(archivos.get(0).getPath().contains(".docx")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[1], archivos.get(0), "application/msword")
                        .multiPart(nameKeys[2], archivos.get(1), "application/msword")
                        .multiPart(nameKeys[3], archivos.get(2), "application/msword")
                        .multiPart(nameKeys[4], archivos.get(3), "application/msword")
                        .multiPart(nameKeys[0], body, "text/plain")
                        .when()
                        .post(resource);
            }else if(archivos.get(0).getPath().contains(".jpg")) {
                rest().relaxedHTTPSValidation()
                        .headers(header)
                        .multiPart(nameKeys[1], archivos.get(0), "image/jpeg")
                        .multiPart(nameKeys[2], archivos.get(1), "application/pdf")
                        .multiPart(nameKeys[3], archivos.get(2), "application/pdf")
                        .multiPart(nameKeys[4], archivos.get(3), "application/pdf")
                        .multiPart(nameKeys[0], body, "text/plain")
